...
if (isset($_POST['pay_button'])) {
    ...
    if($result->num_rows == 1 && $row['PAYmtype'] == 'Standard'){
        $errors[] = "You already standard member.";
    }

    elseif ($row['PAYmtype'] == 'Premium') {
        ...
        VALUES ('$_SESSION[user_id]', 'Standard', '1', '$payDate')";
...
<body>
    ...
    <input type="radio" name="optionScreen" id="SignIn" hidden checked>
        ...
        <form action="membership-type1.php" id="SignInFormData" method="post">
